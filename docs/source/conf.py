...
Notes:
    ...
    rm -rf ~/code/ubelt/docs/source/auto
    cd ~/code/ubelt/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/ubelt/docs/source/auto ~/code/ubelt/ubelt
...
mod_dpath = join(repo_dpath, 'ubelt')
