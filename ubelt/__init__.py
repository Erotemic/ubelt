...
if __DYNAMIC__:  # nocover
    # dynamically create and execute the string that would be autogenerated
    from ubelt.tools import autoinit
    execstr = autoinit.init_execstr(__file__, GLOBAL_MODULES, attrs=True,
                                    use_all=True)
    exec(execstr)
    # If dynamic, imports can be autogenerated
    # TODO: use a the dynamic version instead
