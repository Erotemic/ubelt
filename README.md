...
UBelt is written in pure Python and integrated into the python package index.
Just pip install it and then import it!
...
`utool`(https://github.com/Erotemic/utool) into a standalone module with
